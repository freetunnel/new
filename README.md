...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install brotli -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/freetunneling/new/main/premi.sh && chmod +x premi.sh && ./premi.sh
</code></pre>
...
```
### CONTACT FREE TUNNELING PROJECT<a href="https://t.me/freetunnelproject" target=”_blank”><img src="https://img.shields.io/static/v1?style=for-the-badge&logo=Telegram&label=Telegram&message=Click%20Here&color=blue"></a><br>
```
